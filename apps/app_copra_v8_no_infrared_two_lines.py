                        ...
                        if point2_x1 < x < point2_x2 and abs(y - point_y) < 100:
                            if track_id not in crossed_objects_line_2:
                                ...
                                if class_id == 0 or class_id == 1:
                                    ...
                                    # Update the text area
                                    update_text(formatted_datetime, quality, accuracy, object_width, object_height, edible_counter_2, total_counter_2, line)
                                ...
                                if class_id == 2 or class_id == 3:
                                    ...
                                    # Update the text area
                                    update_text(formatted_datetime, quality, accuracy, object_width, object_height, non_edible_counter_2, total_counter_2, line)
